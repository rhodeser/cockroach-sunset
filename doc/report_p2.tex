...
%TODO Tasks: Pictures: diagram of our system, Serial chart graph results of each test. 
% Code snippets needed: driver code, scaling, PWMDET, pushbutton logic
...
%TODO: Show diagram of closed loop control

 

%	\begin{figure}[h]\centering
%	\includegraphics[height=0.6\textwidth]{block_diagram.png}
%	\caption{PWM Block Diagram}
%		\label{diagram}
%	\end{figure}
...
Micron RAM, lightsensor peripheral, GPIO pins for debug, N3eif peripheral to interface the PMOD rotary encoder and LCD display.  Our circuit board was connected through the other ports.  The PWM in and frequency out pins were...  
...
%TODO Possibly put in the control algorithms we used - although they don't really differ from Robin's very much
...
% Include code here. 
%
\begin{lstlisting}[caption=Bang Bang Implementation, label=bang]		
...
Our work was split up as follows:
	...
	\subsection{Challenges}
		...
		\begin{itemize}				
		%TODO Fill these out
		\item \textbf{Xilinx}: This ``tool'' screwed us over a lot.
		\item \textbf{Hardware interfacing}: PWMDET errors
		\item \textbf{Debugging}: Incorrect readings, 
		\item \textbf{Typecasting}: Gave values converted incorrectly or with lost precision
		\item \textbf{Integration}: We wrote them separately very early on, but it was hard to integrate and fix all the different issues
		\end{itemize}
