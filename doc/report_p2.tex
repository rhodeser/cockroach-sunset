...
Fairly linear, why a drop off at the end?

%	\begin{figure}[h]\centering
%	\includegraphics[height=0.7\textwidth]{images/characterization.png}
%	\caption{Characterization of light sensor}
%		\label{characterization}
%	\end{figure}

\subsection{Bang Bang}
Oscillates back and forth with an error of ...? Was this as expected?

%	\begin{figure}[h]\centering
%	\includegraphics[height=0.7\textwidth]{images/bang_bang.png}
%	\caption{Results using Bang Bang Control}
%		\label{bang_bang}
%	\end{figure}
...
%	\begin{figure}[h]\centering
%	\includegraphics[height=0.7\textwidth]{images/PID.png}
%	\caption{Results using PID Control}
%		\label{PID}
%	\end{figure}

%	\begin{figure}[h]\centering
%	\includegraphics[height=0.7\textwidth]{images/PID2.png}
%	\caption{Results using PID Control}
%		\label{PID2}
%	\end{figure}
