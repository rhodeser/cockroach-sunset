------------------------------------------------------------------------------
-- d_usb_epp_dstm.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
use d_usb_epp_dstm_v1_00_a.d_usb_imp;
...
end entity d_usb_epp_dstm;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of d_usb_epp_dstm is
...
begin
  ...
  ------------------------------------------
  D_USB_EPP_DSTM_I : entity d_usb_epp_dstm_v1_00_a.d_usb_imp
    generic map
    (
